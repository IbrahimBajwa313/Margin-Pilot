...
"[project]/Workshop-Profit-Pilot/apps/web/app/(dashboard)/tools/margin-calculator/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MarginCalculatorPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MarginCalculatorPage.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                ...
                if (Array.isArray(parsed) && parsed.length > 0) {
                    const items = parsed.filter({
                        "MarginCalculatorPage.useEffect.items": (x)=>x != null && typeof x === "object" && typeof x.id === "string" && typeof x.markup === "number" && typeof x.margin === "number"
                    }["MarginCalculatorPage.useEffect.items"]).map({
                        "MarginCalculatorPage.useEffect.items": (x)=>({
                                id: x.id,
                                category: typeof x.category === "string" ? x.category : "",
                                markup: x.markup,
                                margin: x.margin
                            })
                    }["MarginCalculatorPage.useEffect.items"]);
                    if (items.length > 0) update("marginCalc", {
                        strategies: items
                    });
                }
            } catch  {
    ...
    const setCost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setCost]": (v)=>{
            update("marginCalc", {
                cost: v
            });
            recalc(v, price, markup, margin, "cost", update);
        }
    }["MarginCalculatorPage.useCallback[setCost]"], [
        price,
        markup,
        margin,
        update
    ]);
    const setPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setPrice]": (v)=>{
            update("marginCalc", {
                price: v
            });
            recalc(cost, v, markup, margin, "price", update);
        }
    }["MarginCalculatorPage.useCallback[setPrice]"], [
        cost,
        markup,
        margin,
        update
    ]);
    const setMarkup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setMarkup]": (v)=>{
            update("marginCalc", {
                markup: v
            });
            recalc(cost, price, v, margin, "markup", update);
        }
    }["MarginCalculatorPage.useCallback[setMarkup]"], [
        cost,
        price,
        margin,
        update
    ]);
    const setMargin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setMargin]": (v)=>{
            update("marginCalc", {
                margin: v
            });
            recalc(cost, price, markup, v, "margin", update);
        }
    }["MarginCalculatorPage.useCallback[setMargin]"], [
        cost,
        price,
        markup,
        update
    ...
    const addItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[addItem]": ()=>{
    ...
    const removeStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[removeStrategy]": (id)=>{
            update("marginCalc", {
                strategies: strategies.filter({
                    "MarginCalculatorPage.useCallback[removeStrategy]": (s)=>s.id !== id
                }["MarginCalculatorPage.useCallback[removeStrategy]"])
            });
        }
    }["MarginCalculatorPage.useCallback[removeStrategy]"], [
        strategies,
    ...
    const updateStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f2e$ignored$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[updateStrategy]": (id, field, value)=>{
            if (field === "category") {
                update("marginCalc", {
                    strategies: strategies.map({
                        "MarginCalculatorPage.useCallback[updateStrategy]": (s)=>s.id === id ? {
                                ...s,
                                category: String(value)
                            } : s
                    }["MarginCalculatorPage.useCallback[updateStrategy]"])
                });
                return;
            }
...
_s(MarginCalculatorPage, "CNehkR0Y7prBqh2iYfEsCfexsk4=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "MarginCalculatorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_48fa75d8._.js.map