...
function MarginCalculatorPage() {
    ...
    const setCost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setCost]": (v)=>{
            update("marginCalc", {
                cost: v,
                price: 0
            });
            recalc(v, 0, markup, margin, update);
        }
    ...
    const setPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setPrice]": (v)=>{
            update("marginCalc", {
                price: v,
                cost: 0
            });
            recalc(0, v, markup, margin, update);
        }
    ...
    const setMarkup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setMarkup]": (v)=>{
            update("marginCalc", {
                markup: v,
                margin: 0
            });
            recalc(cost, price, v, 0, update);
        }
    ...
    const setMargin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[setMargin]": (v)=>{
            update("marginCalc", {
                margin: v,
                markup: 0
            });
            recalc(cost, price, 0, v, update);
        }
    ...
    const addStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarginCalculatorPage.useCallback[addStrategy]": ()=>{
            const c = cost || price / (1 + markup / 100) || 0;
            const p = price || cost * (1 + markup / 100) || 0;
            const mup = markup || (p - c) / c * 100;
            const mar = margin || (p - c) / p * 100;
            const next = [
                ...strategies,
                {
    ...
    const removeStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const updateStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const c = cost || (price && margin ? round2(price * (1 - margin / 100)) : 0);
    const p = price || (cost && markup ? round2(cost * (1 + markup / 100)) : 0);
    const mup = markup || (c && p ? round2((p - c) / c * 100) : 0);
    const mar = margin || (c && p ? round2((p - c) / p * 100) : 0);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-muted-foreground",
                                children: "Changing one field clears its pair (Cost↔Price, Markup↔Margin). Others are calculated."
                            }, void 0, false, {
                                fileName: "[project]/Workshop-Profit-Pilot/apps/web/app/(dashboard)/tools/margin-calculator/page.tsx",
                                lineNumber: 124,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        className: "pt-0",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Workshop$2d$Profit$2d$Pilot$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MarginCalculatorPage, "IJMG9ag4RF4mZoG57pR9CvwHmt4=", false, function() {
    return [
...
function recalc(cost, price, markup, margin, update) {
    let c = cost;
    let p = price;
    let mup = markup;
    let mar = margin;
    if (c && p) {
        mup = round2((p - c) / c * 100);
        mar = round2((p - c) / p * 100);
        update("marginCalc", {
            markup: mup,
            margin: mar
        });
    } else if (c && mup) {
        p = round2(c * (1 + mup / 100));
        mar = round2((p - c) / p * 100);
        update("marginCalc", {
            price: p,
            margin: mar
...
//# sourceMappingURL=Workshop-Profit-Pilot_apps_web_6887a769._.js.map